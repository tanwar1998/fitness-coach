...
export function AiCoachInput({ onSend, disabled = false }: AiCoachInputProps) {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <div className="flex items-end gap-2 rounded-2xl border border-input bg-card p-2 shadow-sm transition-shadow focus-within:ring-2 focus-within:ring-ring">
        <textarea
          ref={textareaRef}
          rows={1}
          value={value}
